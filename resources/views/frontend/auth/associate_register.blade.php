...
@section('content')
    <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
            <div class="container">
                <h3 class="breadcrumbs-custom-title">Associate Registration</h3>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="sdw" id="form_id">
                        ...
                        <div class="row row-20 gutters-20">
                            ...
                            <div class="col-md-12">
                                <div class="form-wrap floating-label">
                                    <input class="form-input" id="referral_code" type="text" name="referral_code" value="{{$referral_code}}" placeholder="Referral Code" readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-wrap floating-label">
                                    <input class="form-input" id="aadhar_number" type="text" name="aadhar_number" placeholder="Aadhar Number*...">
