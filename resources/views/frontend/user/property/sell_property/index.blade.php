                                    ...
                                    <div class="_prt_filt_dash_flex">
                                        <form>
                                            <div class="row justify-content-end">
                                                <div class="col-md-3">
                                                    <select name="search_status" class="form-control" data-toggle="select2"
                                                        onchange="fillter()">
                                                        <option value="">Select Status...</option>
                                                        <option value="available"
                                                            @if ($search_status == 'available') selected @endif>Available
                                                        </option>
                                                        <option value="on_hold"
                                                            @if ($search_status == 'on_hold') selected @endif>On Hold
                                                        </option>
                                                        <option value="reserved"
                                                            @if ($search_status == 'reserved') selected @endif>Reserved
                                                        </option>
                                                        <option value="booked"
                                                            @if ($search_status == 'booked') selected @endif>Booked
                                                        </option>
                                                        <option value="registred"
                                                            @if ($search_status == 'registred') selected @endif>Registred
                                                        </option>
                                                        <option value="sold"
                                                            @if ($search_status == 'sold') selected @endif>Sold</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                            ...
                                                            <div class="dash_prt_wrap">
                                                                <div class="dash_prt_caption">
                                                                    ...
                                                                    <div class="prt_dash_rate">
                                                                        <span>{{ ucfirst($property->project->project_type) }}</span>
                                                                    </div>
                                                                    <div class="prt_dashb_lot">
                                                                        {{ $property->project->address }}</div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                                ...
                                                                @if ($property->bookProperty?->booking_status != 'emi')
                                                                    @if ($property->booking_status != 'available')
                                                                        @if ($property->bookProperty?->booked_by == Auth::guard('web')->user()->id)
                                                                            <a href="{{ route('user.sell.property.detail', encrypt($property->id)) }}"
