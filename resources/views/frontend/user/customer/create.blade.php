                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="dashboard-body">
                                    <div class="dashboard-wraper">
                                        <form class="form form-horizontal mar-top" action="{{ route('user.customer.store') }}" method="POST">
                                            @csrf
                                            <div class="card">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6 form_div">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="phone" class="form-control" value="{{old('phone')}}" placeholder="Enter Phone... ">
                                                                @error('phone')
                                                                    <small class="text-danger">{{ $message }}</small>
                                                                @enderror
                                                            </div>
