                    ...
                    <div class="property_block_wrap">
                        ...
                        <div class="block-body">
                            <div class="map-container">
                                @php
                                    $address = $property_detail->landmark.', '.$property_detail->cities->name.', India';
                                    $map = '<iframe width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=' . str_replace(",", "", str_replace(" ", "+", $address)) . '&z=14&output=embed"></iframe>';
                                @endphp
                                {!!$map!!}
                            </div>
                        </div>
