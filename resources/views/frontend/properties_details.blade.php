							...
							<div class="property_block_wrap">
								...
								<div class="block-body">
									<div class="property_video">
										<div class="thumb">
											<img class="pro_img img-fluid w100" src="{{ asset('frontend/assets/img/p-3.png')}}" alt="7.jpg')}}">
									...
									<div class="accordion" id="floor-option">
										<div class="card">
											...
											<div id="groundfloor" class="collapse show" aria-labelledby="groundFloor" data-parent="#floor-option">
												<div class="card-body">
													<img src="{{ asset('frontend/assets/img/floor.jpg')}}" class="img-fluid" alt="" />
												</div>
											</div>
										</div>
										<div class="card">
										...
										<div class="comment-list">
											<ul>
												...
												<li class="article_comments_wrap">
													<article>
														<div class="article_comments_thumb">
															<img src="{{ asset('frontend/assets/img/team-5.jpg')}}" alt="">
														</div>
														<div class="comment-details">
															<div class="comment-meta">
																<div class="comment-left-meta">
												...
												<li class="article_comments_wrap">
													<article>
														<div class="article_comments_thumb">
															<img src="{{ asset('frontend/assets/img/team-6.jpg')}}" alt="">
														</div>
														<div class="comment-details">
															<div class="comment-meta">
																<div class="comment-left-meta">
