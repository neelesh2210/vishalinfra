                                ...
                                @foreach ($similer_properties as $similer_property)
                                    <div class="sides_list_property">
                                        ...
                                        <div class="sides_list_property_detail">
                                            <h4><a
                                                    href="{{ route('property.detail', $similer_property->slug) }}">{{ $similer_property->name }}</a>
                                            </h4>
                                            <span><i
                                                    class="ti-location-pin"></i>{{ optional($similer_property->project)->city }},
                                                {{ optional($similer_property->project)->state }},
                                                {{ optional($similer_property->project)->country }} -
                                                {{ optional($similer_property->project)->pincode }}</span>
