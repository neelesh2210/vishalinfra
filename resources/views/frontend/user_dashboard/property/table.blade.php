            ...
            <tr>
                ...
                <td class="text-center">
                    @if($property->booking_status == 'available')
                        @if(Auth::guard('web')->user()->type == 'customer')
                            <a href="{{route('user.property.booking.request',encrypt($property->id))}}" class="btn btn-primary">Booking Request</a>
                        @elseif(Auth::guard('web')->user()->type == 'associate')
                            <a href="{{route('user.property.detail',$property->id)}}" class="btn btn-primary">Book</a>
                        @endif
                    @endif
                </td>
            </tr>
