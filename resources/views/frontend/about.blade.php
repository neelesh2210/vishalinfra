...
@section('content')
			...
			<section>
				...
				<div class="container">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6">
							<img src="{{ asset('frontend/assets/img/immio.jpg')}}" class="img-fluid rounded" alt="" />
						</div>
			...
			<!-- ============================ Our Counter Start ================================== -->
			<section class="image-cover" style="background:#00966a url({{ asset('frontend/assets/img/pattern.png')}}) no-repeat;">
				<div class="container">
							...
							<div class="team-slide item-slide">
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('frontend/assets/img/user-1.jpg')}}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('frontend/assets/img/user-3.jpg')}}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('frontend/assets/img/user-4.jpg')}}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('frontend/assets/img/user-5.jpg')}}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('frontend/assets/img/user-6.jpg')}}" alt="" class="img-fluid" />
										</div>
					...
					<div class="row">
							...
							<div class="grid_blog_box">
								...
								<div class="modern_property_footer">
									<div class="property-author">
										<div class="path-img"><a href="agent-page.html" tabindex="-1"><img src="{{ asset('frontend/assets/img/user-1.jpg')}}" class="img-fluid" alt=""></a></div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="grid_blog_box">
								...
								<div class="gtid_blog_thumb">
									<a href="blog-detail.html"><img src="{{ asset('frontend/assets/img/b-5.jpg')}}" class="img-fluid" alt="" /></a>
								...
								<div class="modern_property_footer">
									<div class="property-author">
										<div class="path-img"><a href="agent-page.html" tabindex="-1"><img src="{{ asset('frontend/assets/img/user-2.jpg')}}" class="img-fluid" alt=""></a></div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="grid_blog_box">
								...
								<div class="gtid_blog_thumb">
									<a href="blog-detail.html"><img src="{{ asset('frontend/assets/img/b-6.jpg')}}" class="img-fluid" alt="" /></a>
								...
								<div class="modern_property_footer">
									<div class="property-author">
										<div class="path-img"><a href="agent-page.html" tabindex="-1"><img src="{{ asset('frontend/assets/img/user-3.jpg')}}" class="img-fluid" alt=""></a></div>
