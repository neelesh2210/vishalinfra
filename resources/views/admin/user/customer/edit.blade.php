...
<style>
                        ...
                        <div class="card card-outline card-primary mt-4">
                            ...
                            <div class="card-body p-0">
                                <div class="modal-body">
                                    <form class="form-example" id="form_id" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="referral_code" name="referral_code" value="{{$customer->referral_code}}" placeholder="Enter Referral Code...">
                                                </div>
    ...
    <script>
        ...
        function submit_form(){
            $.ajax({
                type: 'POST',
                url: "{{route('admin.update.customer')}}",
                data: $('#form_id').serialize()+"&type=customer&user_id="+"{{$customer->id}}",
                contentType: false,
                processData: false,
                success: function(data) {
                    ...
                    console.log(data);
                    return false;
                    window.location.replace("{{route('admin.customers')}}");
        ...
        img_input6.onchange = evt =>{
            const [file] = img_input6.files
            if (file) {
