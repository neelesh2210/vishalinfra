    ...
    <tbody>
        @forelse ($customers as $key=>$customer)
            <tr>
                ...
                <td class="text-center">₹ {{round($customer->associate_credit_wallet_amount_sum_amount - $customer->associate_debit_wallet_amount_sum_amount,2)}}</a></td>
                <td>
                ...
                <td>
                    <a href="{{route('admin.edit.associate',$customer->id)}}" class="btn btn-outline-primary btn-sm mr-1 mb-1">
                        <i class="fas fa-edit "></i>
                    </a>
                    <a href="{{route('admin.associate.wallet.index',$customer->id)}}" class="btn btn-outline-success btn-sm mr-1 mb-1">
                        <i class="fas fa-donate donate-color"></i>
                    </a>
                </td>
            </tr>
        @empty
