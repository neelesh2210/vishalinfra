                        ...
                        <div class="card card-outline card-primary mt-4">
                            ...
                            <div class="card-body p-0">
                                <div class="modal-body">
                                    <form class="form-example" action="{{route('admin.project.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pincode" name="pincode" placeholder="Enter Pincode..." onkeyup="get_address()">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form_div">
                                                <div class="form-group">
