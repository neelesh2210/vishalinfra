        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row m-1">
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('admin.phase.create')}}" class="btn btn-primary float-right">Add Phase <i class="fas fa-plus"></i></a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <div class="card-tools">
                                    <form action="{{route('admin.phase.index')}}" id="search_form">
                                        <div class="row">
                                            <div class="input-group input-group-sm sel" style="width: 200px;">
                                                <select name="search_project" class="form-control select2" onchange="fillter()">
                                                    ...
                                                    @foreach (App\Models\Admin\Project::where('is_delete','0')->get() as $project)
                                                        <option value="{{$project->id}}" @if($search_project == $project->id) selected @endif>{{$project->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
