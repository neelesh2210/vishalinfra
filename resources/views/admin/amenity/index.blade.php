        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row m-1">
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('admin.amenities.create')}}" class="btn btn-primary float-right">Add Amenity <i class="fas fa-plus"></i></a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <div class="card-tools">
                                    <form action="{{route('admin.amenities.index')}}" id="search_form">
                                        <div class="row">
