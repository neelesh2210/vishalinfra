        ...
        @forelse ($booked_properties as $key=>$booked_property)
            <tr>
                ...
                <td>
                    ...
                    <b>Customer Number: </b> {{$booked_property->customer_phone}}
                </td>
                <td>
                    ...
                    <b>Phase: </b>{{optional($booked_property->property->phase)->name}}
                </td>
                <td>
                    <b>Price: </b>₹ {{$booked_property->property->final_price}} <br>
                    <b>sqft. Price: </b>₹ {{$booked_property->property->price_per_sqft}}
                </td>
                <td>
                    <b>Price: </b>₹ {{$booked_property->property->final_price}} <br>
                ...
                <td class="text-center">
                    ...
                    <a class="btn btn-outline-success btn-sm mr-1 mb-1" title="Installment" href="{{route('admin.property.emi',encrypt($booked_property->id))}}"><i class="fas fa-money-bill"></i></a>
